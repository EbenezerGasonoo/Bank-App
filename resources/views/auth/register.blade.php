<x-guest-layout>
    <x-authentication-card>
        ...
        <div class="mb-6 text-center">
            <h1 class="text-xl font-semibold text-gray-900">Open your account</h1>
            <p class="text-sm text-gray-600 mt-1">Create your Poise Commerce Bank profile in minutes.</p>
        </div>
